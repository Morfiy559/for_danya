      ...
      <div class="row">
        <div class="col-md-7">
          <div class="glide">
              <div class="glide__track" data-glide-el="track">
                  ...
                  <li class="glide__slide"><img src="../клубничка.jpg" alt="пингвин"></li>
                  <li class="glide__slide"><img src="../клубничка2.jpg" alt="пингвин"></li>
                  </ul>
              </div>
          </div>
        </div>
        ...
        >
          <div class="wrapper d-flex flex-column align-items-center product__element">
            ...
            <div class="cost mb-1">280руб</div>
